...
| `04_merge_mtp_and_deploy_vllm.ipynb` | 本体と MTP ヘッドの両方にマージした `mtp.*` 入りモデルを作るジョブ、`SM_VLLM_SPECULATIVE_CONFIG` 付きの vLLM DLC デプロイ、MTP なしとの出力比較、CloudWatch ログでの受理率確認、削除（同ステップ3、未実施） |
